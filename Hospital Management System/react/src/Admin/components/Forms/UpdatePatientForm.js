...
const UpdatePatientForm = ({ patient, update, onClose }) => {
    const { first_name, last_name, date_of_birth, gender, address, phone, email, emergency_contact, medical_history } = patient;
    ...
    const handleSubmit = async (e) => {
        ...
        if(await update(patient.id, formData)) {
            onClose();
        }
    };
